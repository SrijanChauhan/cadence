...
const buildStyles = (VOLT, BG, SURFACE, BORDER) => StyleSheet.create({
  ...
  counterRow: { flexDirection: "row", alignItems: "baseline", gap: 8, marginBottom: 10 },
  counter: { color: VOLT, fontSize: 56, fontWeight: "900", fontFamily: rounded, letterSpacing: -2 },
  counterTotal: { color: "#4A4A4A", fontSize: 18, fontWeight: "900" },
